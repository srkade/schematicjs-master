const DTC_ICC = {
  masterComponents: ["ICC", "B3", "B1", "X90", "G2", "H3", "B2", "H6", "H1", "B4", "SPL1", "S9", "SPL2", "SPL3", "SPL4", "S1", "Y3", "SPL5", "SPL6", "SPL7", "S8", "S7", "S4", "SPL8", "SPL9", "SPL10", "K5", "S13", "SPL11", "SPL12"],
  components: [
    {
      id: "ICC",
